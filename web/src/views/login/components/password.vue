...
<template>
  <div class="login-container">
    <div class="login-form">
      <n-input size="large" v-model:value="data.phone" placeholder="手机号" />
      <n-input size="large" v-model:value="data.password" placeholder="密码" />
      <n-button type="primary" size="large" :disabled="data.phone.length === 0 || data.password.length === 0" style="width: 100%;">登录</n-button>
    </div>
